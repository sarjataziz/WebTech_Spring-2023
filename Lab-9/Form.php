    ...
    <script>
        ...
        function validate() {
            ...
            */
            ...
            if (!get("movies").checked && !get("music").checked && !get("sports").checked && !get("games").checked && !get(
                    "anime").checked) {
                hasError = true;
                get("error_hobbies").innerHTML = "*Hobbies Required";
            }
...
<body>
    <div class="center">
        <form action="" onsubmit="return validate()" method="post">
            <!-- Here return validate() is used to call the function and return used if false return form wont be submit -->
            <!-- Which method would be used and How the form works -->
            <fieldset>
                <h2>Personal Info: </h2>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="username" name="username" value="<?php echo $username; ?>" placeholder="Username">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="Hobbies"><input type="Checkbox" id="movies" value="Movies" <?php if (hobbyExist("Movies")) echo "checked"; ?> name="hobbies[]"> Movies</label>
                            <label for="Hobbies"><input type="Checkbox" id="music" value="Music" <?php if (hobbyExist("Music")) echo "checked"; ?> name="hobbies[]"> Music</label>
                            <label for="Hobbies"><input type="Checkbox" id="sports" value="Sports" <?php if (hobbyExist("Sports")) echo "checked"; ?> name="hobbies[]"> Sports</label>
                            <br>
                            <label for="Hobbies"><input type="Checkbox" id="games" value="Games" <?php if (hobbyExist("Games")) echo "checked"; ?> name="hobbies[]"> Games</label>
                            <label for="Hobbies"><input type="Checkbox" id="anime" value="Anime" <?php if (hobbyExist("Anime")) echo "checked"; ?> name="hobbies[]"> Anime</label>
                        </td>
